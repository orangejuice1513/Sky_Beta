...
bool px4__msg__distance_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._distance_sensor.DistanceSensor", full_classname_dest, 39) == 0);
  }
  px4__msg__DistanceSensor * ros_message = _ros_message;
  {  // timestamp
...
PyObject * px4__msg__distance_sensor__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._distance_sensor");

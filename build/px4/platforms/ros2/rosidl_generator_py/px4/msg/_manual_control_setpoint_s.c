...
bool px4__msg__manual_control_setpoint__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("px4.msg._manual_control_setpoint.ManualControlSetpoint", full_classname_dest, 54) == 0);
  }
  px4__msg__ManualControlSetpoint * ros_message = _ros_message;
  {  // timestamp
...
PyObject * px4__msg__manual_control_setpoint__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("px4.msg._manual_control_setpoint");

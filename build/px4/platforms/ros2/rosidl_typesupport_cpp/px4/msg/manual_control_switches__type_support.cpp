...
static const _ManualControlSwitches_type_support_symbol_names_t _ManualControlSwitches_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, ManualControlSwitches)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, ManualControlSwitches)),
  }
};
...
{
  return &::px4::msg::rosidl_typesupport_cpp::ManualControlSwitches_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4, msg, ManualControlSwitches)() {
  return get_message_type_support_handle<px4::msg::ManualControlSwitches>();
}

...
static const _VehicleTorqueSetpoint_type_support_symbol_names_t _VehicleTorqueSetpoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, VehicleTorqueSetpoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, VehicleTorqueSetpoint)),
  }
};
...
{
  return &::px4::msg::rosidl_typesupport_cpp::VehicleTorqueSetpoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4, msg, VehicleTorqueSetpoint)() {
  return get_message_type_support_handle<px4::msg::VehicleTorqueSetpoint>();
}

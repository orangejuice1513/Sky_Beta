...
static const _SensorsStatusImu_type_support_symbol_names_t _SensorsStatusImu_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, px4, msg, SensorsStatusImu)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, px4, msg, SensorsStatusImu)),
  }
};
...
{
  return &::px4::msg::rosidl_typesupport_cpp::SensorsStatusImu_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, px4, msg, SensorsStatusImu)() {
  return get_message_type_support_handle<px4::msg::SensorsStatusImu>();
}

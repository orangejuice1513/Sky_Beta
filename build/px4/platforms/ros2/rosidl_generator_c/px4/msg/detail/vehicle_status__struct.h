...
enum
{
  px4__msg__VehicleStatus__ARMING_STATE_INIT = 0
};

/// Constant 'ARMING_STATE_STANDBY'.
enum
{
  px4__msg__VehicleStatus__ARMING_STATE_STANDBY = 1
};
...
enum
{
  px4__msg__VehicleStatus__ARMING_STATE_STANDBY_ERROR = 3
};

/// Constant 'ARMING_STATE_SHUTDOWN'.
enum
{
  px4__msg__VehicleStatus__ARMING_STATE_SHUTDOWN = 4
};

/// Constant 'ARMING_STATE_IN_AIR_RESTORE'.
enum
{
  px4__msg__VehicleStatus__ARMING_STATE_IN_AIR_RESTORE = 5
};

/// Constant 'ARMING_STATE_MAX'.
enum
{
  px4__msg__VehicleStatus__ARMING_STATE_MAX = 6
};

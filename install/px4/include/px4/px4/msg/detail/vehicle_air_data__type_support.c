...
static rosidl_typesupport_introspection_c__MessageMember px4__msg__VehicleAirData__rosidl_typesupport_introspection_c__VehicleAirData_message_member_array[8] = {
  {
    "timestamp",  // name
